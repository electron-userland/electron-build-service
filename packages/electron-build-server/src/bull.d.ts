...
declare module "bull" {
  ...
  declare namespace Bull {
    ...
    interface Queue {
       ...
       */
      clean(grace: number, status?: JobStatus, limit?: number): Promise<Array<Job>>
       ...
       */
      on(event: string, callback: (...args: Array<any>) => void): this
    ...
    type CleanedEventCallback = (jobs: Array<Job>, status: JobStatus) => void
  }
